...
func TestSubscribeAddress_ILC(t *testing.T) {

	var (
		endRunning = make(chan bool, 1)
		symbol     = "ILC"
		addrs      = map[string]string{
		//	"1JnDGrLMJhqK6a692NV5rqMdmstsg1bS4f": "sender",
			"1EgqGx9VqX3DFbT5x6sxB47eKYoYwDhdsN": "reviver",
		}
	)
	...
	scanner.SetRescanBlockHeight(343211)
