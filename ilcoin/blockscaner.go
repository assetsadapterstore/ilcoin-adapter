...
const (
	...
	RPCServerCore     = 0 //RPC服务，ilcoin核心钱包
	RPCServerExplorer = 1 //RPC服务，insight-API
)

//ILCBlockScanner ilcoin的区块链扫描器
type ILCBlockScanner struct {
...
//NewILCBlockScanner 创建区块链扫描器
func NewILCBlockScanner(wm *WalletManager) *ILCBlockScanner {
	bs := ILCBlockScanner{
...
func (bs *ILCBlockScanner) SetRescanBlockHeight(height uint64) error {
	height = height - 1
	if height < 0 {
...
//ScanBlockTask 扫描任务
func (bs *ILCBlockScanner) ScanBlockTask() {
...
//ScanBlock 扫描指定高度区块
func (bs *ILCBlockScanner) ScanBlock(height uint64) error {
...
func (bs *ILCBlockScanner) scanBlock(height uint64) (*Block, error) {
...
func (bs *ILCBlockScanner) ScanTxMemPool() {
...
func (bs *ILCBlockScanner) RescanFailedRecord() {
...
func (bs *ILCBlockScanner) newBlockNotify(block *Block, isFork bool) {
...
//ilcoin 1M的区块链可以容纳3000笔交易，批量多线程处理，速度更快
func (bs *ILCBlockScanner) BatchExtractTransaction(blockHeight uint64, blockHash string, txs []string) error {
...
func (bs *ILCBlockScanner) extractRuntime(producer chan ExtractResult, worker chan ExtractResult, quit chan struct{}) {
...
func (bs *ILCBlockScanner) ExtractTransaction(blockHeight uint64, blockHash string, txid string, scanAddressFunc openwallet.BlockScanAddressFunc) ExtractResult {
...
func (bs *ILCBlockScanner) extractOmniTransaction(trx *OmniTransaction, result *ExtractResult, scanAddressFunc openwallet.BlockScanAddressFunc) {
...
func (bs *ILCBlockScanner) extractTransaction(trx *Transaction, result *ExtractResult, scanAddressFunc openwallet.BlockScanAddressFunc) {
...
func (bs *ILCBlockScanner) extractTxInput(trx *Transaction, result *ExtractResult, scanAddressFunc openwallet.BlockScanAddressFunc) ([]string, decimal.Decimal) {
...
//ExtractTxInput 提取交易单输入部分
func (bs *ILCBlockScanner) extractTxOutput(trx *Transaction, result *ExtractResult, scanAddressFunc openwallet.BlockScanAddressFunc) ([]string, decimal.Decimal) {
...
func (bs *ILCBlockScanner) newExtractDataNotify(height uint64, extractData map[string]*openwallet.TxExtractData) error {
...
func (bs *ILCBlockScanner) DeleteUnscanRecordNotFindTX() error {
...
//func (bs *ILCBlockScanner) SaveRechargeToWalletDB(height uint64, list []*openwallet.Recharge) error {
//
//	for _, r := range list {
//
...
func (bs *ILCBlockScanner) GetScannedBlockHeader() (*openwallet.BlockHeader, error) {
...
func (bs *ILCBlockScanner) GetCurrentBlockHeader() (*openwallet.BlockHeader, error) {
...
func (bs *ILCBlockScanner) GetGlobalMaxBlockHeight() uint64 {
	maxHeight, err := bs.wm.GetBlockHeight()
	if err != nil {
...
func (bs *ILCBlockScanner) GetScannedBlockHeight() uint64 {
	localHeight, _, _ := bs.GetLocalNewBlock()
	return localHeight
}

func (bs *ILCBlockScanner) ExtractTransactionData(txid string, scanTargetFunc openwallet.BlockScanTargetFunc) (map[string][]*openwallet.TxExtractData, error) {
...
//func (bs *ILCBlockScanner) DropRechargeRecords(accountID string) error {
//	bs.mu.RLock()
//	defer bs.mu.RUnlock()
//
...
//func (bs *ILCBlockScanner) DeleteRechargesByHeight(height uint64) error {
//
//	bs.mu.RLock()
//	defer bs.mu.RUnlock()
//
...
func (bs *ILCBlockScanner) SaveUnscanRecord(record *openwallet.UnscanRecord) error {
...
//func (bs *ILCBlockScanner) GetWalletByAddress(address string) (*openwallet.Wallet, bool) {
//	bs.mu.RLock()
//	defer bs.mu.RUnlock()
//
...
func (bs *ILCBlockScanner) GetLocalNewBlock() (uint64, string, error) {
...
func (bs *ILCBlockScanner) SaveLocalNewBlock(blockHeight uint64, blockHash string) error {
...
func (bs *ILCBlockScanner) SaveLocalBlock(block *Block) error {
...
func (bs *ILCBlockScanner) GetLocalBlock(height uint64) (*Block, error) {
...
//获取未扫记录
func (bs *ILCBlockScanner) GetUnscanRecords() ([]*openwallet.UnscanRecord, error) {
...
func (bs *ILCBlockScanner) DeleteUnscanRecord(height uint64) error {
	if bs.BlockchainDAI == nil {
		return fmt.Errorf("Blockchain DAI is not setup ")
	}
...
func (bs *ILCBlockScanner) GetBalanceByAddress(address ...string) ([]*openwallet.Balance, error) {
...
func (bs *ILCBlockScanner) GetTransactionsByAddress(offset, limit int, coin openwallet.Coin, address ...string) ([]*openwallet.TxExtractData, error) {
...
//Run 运行
func (bs *ILCBlockScanner) Run() error {
...
////Stop 停止扫描
func (bs *ILCBlockScanner) Stop() error {
...
//
////Pause 暂停扫描
//func (bs *ILCBlockScanner) Pause() error {
//	if bs.wm.Config.RPCServerType == RPCServerExplorer {
//		return nil
//	} else {
...
//
////Restart 继续扫描
//func (bs *ILCBlockScanner) Restart() error {
//	if bs.wm.Config.RPCServerType == RPCServerExplorer {
//		return nil
//	} else {
...
func (bs *ILCBlockScanner) connectSocketIO(disconnected chan struct{}) (*gosocketio.Client, error) {
...
func (bs *ILCBlockScanner) setupSocketIO() error {
...
//@optional
func (bs *ILCBlockScanner) SupportBlockchainDAI() bool {
	return true
}
