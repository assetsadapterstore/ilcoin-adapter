...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO ILC", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WAepmXczPULrWEz9tRvPBK6PcSVZYjk2yP")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	tm := testInitWalletManager()
	walletID := "WAepmXczPULrWEz9tRvPBK6PcSVZYjk2yP"
	account := &openwallet.AssetsAccount{Alias: "mainnetILC", WalletID: walletID, Required: 1, Symbol: "ILC", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "WAepmXczPULrWEz9tRvPBK6PcSVZYjk2yP"
	accountID := "GsQYmWgPjG7Uvcuwp5zTy1cEesY2Jx6NCVFjsdJmHQnS"
