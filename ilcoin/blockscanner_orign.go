...
//func (bs *ILCBlockScanner) SetScanBlockTaskOrigin() {
//	bs.SetTask(bs.ScanBlockTaskOrigin)
//}
//
////ScanBlockTask 扫描任务
//func (bs *ILCBlockScanner) ScanBlockTaskOrigin() {
//
//	//获取本地区块高度
...
//func (bs *ILCBlockScanner) ScanTxMemPoolOrigin() {
//
...
//func (bs *ILCBlockScanner) BatchExtractTransactionOrigin(block *Block) error {
//
//	var (
//		done       = 0 //完成标记
...
//
////AddObserver 添加观测者
//func (bs *ILCBlockScanner) AddBTCBlockObserver(obj BTCBlockScanNotificationObject) error {
//	bs.Mu.Lock()
//
//	defer bs.Mu.Unlock()
//
...
//func (bs *ILCBlockScanner) RemoveBTCBlockObserver(obj BTCBlockScanNotificationObject) error {
//	bs.Mu.Lock()
//	defer bs.Mu.Unlock()
//
...
//func (bs *ILCBlockScanner) NewBTCBlockNotify(block *Block, isFork bool) {
//	block.Fork = isFork
...
//func (bs *ILCBlockScanner) GetScannedBlockHeaderOrigin() (*openwallet.BlockHeader, error) {
//
//	var (
